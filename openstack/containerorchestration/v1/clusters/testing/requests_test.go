		...
		fmt.Fprintf(w, `
{
    "clusters": [
    {
      ...
      "master_count": 1,
      "cluster_template_id": "5b793604-fc76-4886-a834-ed522812cdcb",
      "node_count": 1,
      "bay_createcreate_timeout_timeout": 0,
      "name": "k8sbay"
    }
  ]
}
  ...
  "errors": [
    {
      ...
      "detail": "Multiple clusters exist with same name. Please use the bay uuid instead.",
      "request_id": ""
    }
  ]
}
	...
	th.AssertEquals(t, "Multiple clusters exist with same name. Please use the bay uuid instead.", res.Err.Error())
		...
		fmt.Fprintf(w, `
{
  "errors": [
	...
	options := clusters.CreateOpts{Name: "mycluster", Nodes: 2, ClusterTemplateID: "5b793604-fc76-4886-a834-ed522812cdcb", KeyPair: "test"}
