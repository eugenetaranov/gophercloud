...
// ClusterListQuery formats a ListOpts into a query string.
func (opts ListOpts) ClusterListQuery() (string, error) {
...
func List(c *gophercloud.ServiceClient, opts ListOptsBuilder) pagination.Pager {
	url := listURL(c)
	if opts != nil {
		query, err := opts.ClusterListQuery()
		if err != nil {
...
type CreateOptsBuilder interface {
	ClusterCreateMap() (map[string]interface{}, error)
}
...
func (opts CreateOpts) ClusterCreateMap() (map[string]interface{}, error) {
