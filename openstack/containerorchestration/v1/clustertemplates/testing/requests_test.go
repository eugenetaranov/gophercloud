		...
		fmt.Fprintf(w, `
{
  "clustertemplates": [
	...
	results := clustertemplates.List(client)
  ...
  "errors": [
    {
      ...
      "detail": "Multiple clustertemplates exist with same name. Please use the baymodel uuid instead.",
      "request_id": ""
    }
  ]
}
	...
	th.AssertEquals(t, "Multiple clustertemplates exist with same name. Please use the baymodel uuid instead.", res.Err.Error())
